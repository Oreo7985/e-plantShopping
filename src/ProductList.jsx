...
function ProductList() {
    ...
    const [addedItems, setAddedItems] = useState({}); // State to store the items added to the cart
                    ...
                    <div className='product-list'>
                        {category.plants.map((plant, index) => (
                            <div key={index} className='product-card'>
                                ...
                                <button 
                                    className={`product-button ${plant.name in addedItems ? 'added-to-cart' : ''}`}
                                    onClick={() => handleAddToCart(plant)}
                                >
                                    {plant.name in addedItems ? 'Added to Cart' : 'Add to Cart'}
                                </button>
                            </div>
                        ))
                        }
